...
Finally, we show that the minimum-norm solution is unique. Denote the minimun-norm solution by $\widetilde{u}$. Now suppose we have another solution, $\widetilde{v}$, to {eq}`minres`. Now take $v(t) = \widetilde{u} + t(\widetilde{v} - \widetilde{u})$. We have $K^*\!K v(t) = K^*\!K \widetilde{u} + t K^*\! K (\widetilde{v} - \widetilde{u}) = K^*\!f + t(K^*\!f - K^*\!f) = K^*\!f$. So $v(t)$ is a solution to the normal equations as well. Moreover, $v(t)$ is a linear combination of elements of $\mathcal{N}(K)^{\perp}$. Hence, $v(t) \in \mathcal{N}(K)^{\perp}$. If we can show that for small enough $t$, $\|v(t)\|_{\mathcal{U}}^2 \leq \|\widetilde{u}\|_{\mathcal{U}}^2$ or $\|v(t)\|_{\mathcal{U}}^2 \leq \|\widetilde{v}\|_{\mathcal{U}}^2$, we have shown that either $\|\widetilde{u}\|_{\mathcal{U}}^2$ or $\|\widetilde{v}\|_{\mathcal{U}}^2$ can not be the minimal norm solution. We get $\|v(t)\|_{\mathcal{U}}^2=\|\widetilde{u}\|_{\mathcal{U}}^2 + 2t\langle \widetilde{u}, \widetilde{v} - \widetilde{u} \rangle_{\mathcal{U}} + t^2\|\widetilde{v} - \widetilde{u}\|_{\mathcal{U}}^2$. Without loss of generality, assume $\langle \widetilde{u}, \widetilde{v} - \widetilde{u} \geq 0$. If $\langle \widetilde{u}, \widetilde{v} - \widetilde{u} = 0$, then $v(1) = \widetilde{v}$ satisfies $\|\widetilde{v}\|_{\mathcal{U}}^2=\|\widetilde{u}\|_{\mathcal{U}}^2 + \|\widetilde{v} - \widetilde{u}\|_{\mathcal{U}}^2 > \|\widetilde{u}\|_{\mathcal{U}}^2$, which contradicts that $\widetilde{v}$ is a minimal norm solution. Assume $\langle \widetilde{u}, \widetilde{v} - \widetilde{u} > 0$. Taking $t < 0$ with $|t|$ very small, we get $\|v(t)\|_{\mathcal{U}}^2=\|\widetilde{u}\|_{\mathcal{U}}^2 + 2t\langle \widetilde{u}, \widetilde{v} - \widetilde{u} \rangle_{\mathcal{U}} + t^2\|\widetilde{v} - \widetilde{u}\|_{\mathcal{U}}^2 < \|\widetilde{u}\|_{\mathcal{U}}^2$, which contradicts that $\widetilde{u}$ is a minimal norm solution. These contradictions show that there can not be two minimal norm solutions.
